<%@ Page Language="C#" AutoEventWireup="true" CodeFile="home6.aspx.cs" Inherits="home" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span class="auto-style2"><strong>Pratik Book Stores</strong><asp:LinkButton ID="LinkButton7" runat="server" ForeColor="#000066" PostBackUrl="~/login1.aspx" style="z-index: 1; left: 995px; top: 58px; position: absolute; font-size: large">login</asp:LinkButton>
        </span><br />
        <br />
        <br />
        ...
        <asp:Panel ID="Panel1" runat="server" Height="14cm">
            <asp:Panel ID="Panel2" runat="server" Height="57px" style="background-color: #000066">
                <asp:LinkButton ID="LinkButton1" runat="server" Font-Bold="True" Font-Size="Large" style="z-index: 1; left: 114px; top: 117px; position: absolute; font-weight: 700; height: 29px; color: #000000; width: 66px; font-size: x-large; background-color: #FFFFCC;text-decoration:none">Home</asp:LinkButton>
            </asp:Panel>
            ...
            <asp:Panel ID="Panel3" runat="server" Height="264px" Width="235px" style="border:5px solid #CC0000; font-weight: 700; background-color: #CCFFFF; margin-top: 0px; color: #CCFFFF;">
                <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="X-Large" ForeColor="#000066" style="z-index: 1; left: 42px; top: 180px; position: absolute; width: 174px" Text="Books Category"></asp:Label>
                <asp:LinkButton ID="LinkButton4" runat="server" Font-Size="Large" ForeColor="#000066" PostBackUrl="~/view_books.aspx" style="z-index: 1; left: 64px; top: 228px; position: absolute">Computers</asp:LinkButton>
                <asp:LinkButton ID="LinkButton5" runat="server" Font-Bold="True" Font-Size="Large" ForeColor="#000066" PostBackUrl="~/view_books1.aspx" style="z-index: 1; left: 54px; top: 272px; position: absolute">Entertainment</asp:LinkButton>
                
                <asp:LinkButton ID="LinkButton6" runat="server" ForeColor="#000066" PostBackUrl="~/view_books2.aspx" style="z-index: 1; left: 54px; top: 318px; position: absolute">Childrens Book</asp:LinkButton>
