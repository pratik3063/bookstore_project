<%@ Page Language="C#" AutoEventWireup="true" CodeFile="contactus2.aspx.cs" Inherits="contactus2" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span class="auto-style2"><strong>Pratik Book Stores</strong></span><br />
        ...
        <asp:Panel ID="Panel1" runat="server" Height="14.1cm">
            ...
            &nbsp;<asp:Panel ID="Panel3" runat="server" style="font-weight: 700;border:5px solid #CC0000;position:absolute; background-color: #CCFFFF; top: 151px; left: 11px; height: 467px; width: 230px;">
                <asp:LinkButton ID="LinkButton4" runat="server" ForeColor="#000066" Height="29px" style="z-index: 1; left: 72px; top: 126px; position: absolute; font-size: x-large;  font-weight: 700; background-color: #CCFFFF; width: 116px;" PostBackUrl="~/welcome.aspx">Home</asp:LinkButton>
                <asp:LinkButton ID="LinkButton5" runat="server" style="z-index: 1; left: 58px; top: 221px; position: absolute; font-size: x-large; background-color: #CCFFFF;  color: #000066; bottom: 224px;" PostBackUrl="~/aboutus2.aspx">About us</asp:LinkButton>
                <asp:LinkButton ID="LinkButton6" runat="server" style="z-index: 1; left: 49px; top: 321px; position: absolute; font-size: x-large; background-color: #CCFFFF; color: #000066;" PostBackUrl="~/contactus2.aspx">Contact us</asp:LinkButton>
                </asp:Panel>
